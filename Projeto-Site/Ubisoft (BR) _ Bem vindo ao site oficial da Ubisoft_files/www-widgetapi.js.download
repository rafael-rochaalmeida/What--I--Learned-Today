...
var Ja="function"==typeof Object.assign?Object.assign:function(a,b){for(var c=1;c<arguments.length;c++){var d=arguments[c];if(d)for(var e in d)z(d,e)&&(a[e]=d[e])}return a};
...
!Ra(A.setImmediate)||A.Window&&A.Window.prototype&&!J("Edge")&&A.Window.prototype.setImmediate==A.setImmediate?(Pc||(Pc=Qc()),Pc(b)):A.setImmediate(b)}}
...
q.clear=function(a){if(a){var b=this.g[a];b&&(H(b,this.L,this),delete this.g[a])}else this.f.length=0,this.g={}};
...
;function ge(){}
E(ge,fe);ge.prototype.clear=function(){var a=Ad(this.B(!0)),b=this;H(a,function(c){b.remove(c)})};function he(a){this.f=a}
...
function Ih(){return F(this,function b(){var c,d;return y(b,function(e){if(1==e.f)return x(e,Ch(),2);if(3!=e.f)return c=e.g,x(e,c.count("LogsRequestsStore"),3);d=e.g;return e["return"](!d)})})}
function Jh(a){return F(this,function c(){var d;return y(c,function(e){if(1==e.f)return x(e,Ch(),2);d=e.g;return e["return"](d["delete"]("LogsRequestsStore",a))})})}
...
function Zh(a){F(this,function c(){var d=this,e,f,g,h,k;return y(c,function(l){switch(l.f){case 1:e=d;if(!a)return x(l,Fh(),6);if(!a.id){l.v(3);break}return x(l,Gh(a.id),5);case 5:(f=l.g)?a=f:ve(Error("The request cannot be found in the database."));l.v(3);break;case 6:if(a=l.g){l.v(3);break}return x(l,Ih(),8);case 8:return(g=l.g)&&Rh(),l["return"]();case 3:if($h(a))h=a.options.onError?a.options.onError:function(){},k=a.options.onSuccess?a.options.onSuccess:function(){},a.options.onError=function(m,
n){return F(e,function p(){return y(p,function(u){if(1==u.f)return a&&a.id?a.sendCount<Vh?x(u,Hh(a.id),6):x(u,Jh(a.id),2):u.v(2);
2!=u.f&&(Wh||Ph(Oh()),h(m,n));h(m,n);u.f=0})})},a.options.onSuccess=function(m,n){return F(e,function p(){return y(p,function(u){if(1==u.f)return a&&a.id?x(u,Jh(a.id),2):u.v(2);
...
function Yh(){return F(this,function b(){return y(b,function(c){return T("networkless_logging")?(2===Ve("networkless_ytidb_version")&&th().then(function(d){return d}),c["return"](ph())):c["return"](!1)})})}
...
window.postMessage?1:0;window.location.host&&(h.origin=window.location.protocol+"//"+window.location.host);h.widgetid=a.j;window.location.href&&H(["debugjs","debugcss"],function(k){var l=window.location.href;var m=l.search(uc);b:{var n=0;for(var r=k.length;0<=(n=l.indexOf(k,n))&&n<m;){var p=l.charCodeAt(n-1);if(38==p||63==p)if(p=l.charCodeAt(n+r),!p||61==p||38==p||35==p)break b;n+=r+1}n=-1}if(0>n)l=null;else{r=l.indexOf("&",n);if(0>r||r>m)r=m;n+=k.length+1;l=decodeURIComponent(l.substr(n,r-n).replace(/\+/g,
" "))}null!==l&&(h[k]=l)});
...
function si(a,b){H(b,function(c){this[c]||("getCurrentTime"==c?this[c]=function(){var d=this.playerInfo.currentTime;if(1==this.playerInfo.playerState){var e=(C()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:pi(c)?this[c]=function(){this.playerInfo={};
...
Me.push(function(){var a=Pe("thumbnail");H(a,Ji)});
